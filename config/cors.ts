...
/*
  #1:Curso-Adonis - Início de Tudo: 
      Após iniciar o projeto Adonis (TS) na última versão e no diretório atual digitar:
        npm init adonis-ts-app@latest .
        Escolher o tipo de aplicação: api // yes // yes

      #1.1 - node ace serve --watch @@ Colocar o serviço para rodar
      #1.2 - npm i @adonisjs/lucid - Instala o pacote de configuração de banco de dados
      #1.3 - node ace configure @adonisjs/lucid - Configurar este pacote
*/
...
const corsConfig: CorsConfig = {
  ...
  |
    ...
    #2:Curso-Adonis - trocar o 'false' por '(request) => request.url().startsWith('/api')'
  */
